...
st.markdown("""
PSeberapa besar pengaruh kondisi cuaca (weathersit, temp, hum, windspeed) 
...
st.markdown("""
**Pertanyaan:** Pada jam berapa (hr) terjadi puncak penyewaan sepeda (cnt) dan bagaimana perbedaannya 
